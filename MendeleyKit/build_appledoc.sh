...
if type -p appledoc &>/dev/null; then
    appledoc --project-name MendeleyKit --project-company "Mendeley" --company-id com.mendeley --output MendeleyKitHelp --keep-intermediate-files --exit-threshold 2 --ignore .m --ignore MendeleyKitTests . 
else
