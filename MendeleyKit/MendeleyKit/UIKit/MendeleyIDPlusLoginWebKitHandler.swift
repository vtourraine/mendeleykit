...
@available (iOS 9.0, *)
public class MendeleyIDPlusLoginWebKitHandler: NSObject, WKNavigationDelegate, MendeleyLoginHandler
{
    ...
    public func startLoginProcess(_ clientID: String, redirectURI: String, completionHandler: MendeleyCompletionBlock?, oauthHandler: MendeleyOAuthCompletionBlock?)
    {
        ...
        let helper = MendeleyKitIDPlusLoginHelper()
        helper.cleanCookiesAndURLCache()
        
        if let request = idPlusProvider?.getAuthURLRequest() {
