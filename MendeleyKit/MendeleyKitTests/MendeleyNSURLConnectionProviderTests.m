//
//  MendeleyNSURLConnectionProviderTests.m
//  MendeleyKit
//
//  Created by Peter Schmidt on 15/10/2014.
//  Copyright (c) 2014 Mendeley. All rights reserved.
//
...
- (void)testUpload
{
    ...
    waitForBlock ( ^(BOOL *hasCalledBack) {
        ...
        [self.networkProvider invokeUploadForFileURL:fileURL baseURL:self.testURL api:@"post" additionalHeaders:nil authenticationRequired:NO progressBlock:
         ^(NSNumber *progress){
...
- (void)testCancelTask
{
    ...
    __block NSError *errorResponse;
    MendeleyTask *cancellationRequest = [self.networkProvider invokeGET:self.testURL api:@"delay/10"
                                                                                             additionalHeaders:nil
                                                                                               queryParameters:nil
                                                                                        authenticationRequired:NO
                                                                                               completionBlock: ^(MendeleyResponse *response, NSError *error) {
...
- (void)testCancelDownload
{
    ...
    cancellationRequest = [self.networkProvider invokeDownloadToFileURL:destinationURL
                                                                                                       baseURL:self.testURL
                                                                                                           api:@"drip"
                                                                                             additionalHeaders:nil
                                                                                               queryParameters:delayQueryParameters
